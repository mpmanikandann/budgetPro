...
var _serverStore = __webpack_require__(12);

var _serverStore2 = _interopRequireDefault(_serverStore);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = (0, _express2.default)(); // Comman js module syntax
...
app.get("*", function (request, response) {
  var store = (0, _serverStore2.default)(function () {}, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
exports.default = function () {
  var store = (0, _redux.createStore)(function () {}, (0, _redux.applyMiddleware)(_reduxThunk2.default));
